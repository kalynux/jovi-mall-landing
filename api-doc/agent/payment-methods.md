...
>
> This file documents it from the **agent** perspective. The identical reference also lives in [customer](../customer/payment-methods.md), [vendor](../vendor/payment-methods.md), [admin](../admin/payment-methods.md), and [agency](../agency/payment-methods.md) folders.

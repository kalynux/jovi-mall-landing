  ...
  if (!b) {
    return (
      <div className="mx-auto max-w-[680px] px-4 py-6 sm:px-6">
        ...
        <Button variant="secondary" size="sm" onClick={() => router.push("/shop/account/bookings")}>
          Back to bookings
        </Button>
      </div>
    );
    ...
    <div className="mx-auto max-w-[680px] px-4 py-6 sm:px-6">
      ...
      {bal && bal.outstanding > 0 && (
        ...
        >
          ...
          <Button
            size="sm"
            onClick={() => router.push(`/shop/account/bookings/${bookingId}/balance`)}
          >
            Pay the balance
          </Button>
        </div>
      ...
      <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
        ...
        <Button variant="ghost" size="sm" onClick={() => router.push("/shop/account/bookings")}>
          All bookings
        </Button>
      </div>

...
import { BookingBalanceClient } from "@/components/shop/account/QueryScreens";
import { isLocale } from "@/i18n/routing";

/**
 * `/shop/account/booking/balance?id=<bookingId>` — the app's booking balance screen.
 *

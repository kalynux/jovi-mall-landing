...
const COPY = {
  en: {
    ...
    body: "We hit an unexpected problem and could not finish loading WiMall. It is usually temporary — please try again.",
    retry: "Try again",
    home: "Back to home",
  },
  fr: {
    ...
    body: "Un problème inattendu nous a empêchés de charger WiMall. C'est généralement temporaire — veuillez réessayer.",
    retry: "Réessayer",
  ...
  pt: {
    ...
    body: "Ocorreu um problema inesperado e não conseguimos carregar a WiMall. Normalmente é temporário — tente novamente.",
  ...
  es: {
    ...
    body: "Se ha producido un problema inesperado y no hemos podido cargar WiMall. Suele ser temporal: inténtalo de nuevo.",
    retry: "Reintentar",
  ...
  ar: {
    ...
    dir: "rtl",
    title: "حدث خطأ ما",
    body: "واجهنا مشكلة غير متوقعة ولم نتمكن من تحميل WiMall. عادةً ما تكون مؤقتة — يُرجى المحاولة مرة أخرى.",
    retry: "أعد المحاولة",
